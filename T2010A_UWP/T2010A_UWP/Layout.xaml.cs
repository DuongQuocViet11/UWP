...
namespace T2010A_UWP
{
    ...
    public sealed partial class Layout : Page
    {
        public Layout()
        {
            ...
            var item2 = new MenuItem() { Name = "Information", MenuPage = "information", Icon = "\uE946" };
        ...
        {
            MenuItem selected = (MenuItem)Menu.SelectedItem; // Item được chọn để nhấn vào
            switch(selected.MenuPage)
            {
                case "homepage":MainFrame.Navigate(typeof(Pages.Home)); break;
                case "information":MainFrame.Navigate(typeof(Pages.DemoForm)); break;
